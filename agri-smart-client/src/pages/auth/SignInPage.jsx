    ...
    <div className="min-h-screen overflow-x-hidden bg-[#efe7d6]">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        <section
          ...
          style={{
            backgroundImage: `linear-gradient(135deg, rgba(21, 32, 17, 0.82) 0%, rgba(21, 32, 17, 0.58) 45%, rgba(21, 32, 17, 0.38) 100%), url(${backgroundImage})`,
          ...
          <div className="relative z-10 flex h-full flex-col justify-between px-10 py-12 text-white">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-5 text-lg leading-8 text-white/78">
                Sign in to continue managing your farm, products, and marketplace activity.
              </p>
            </div>
            ...
            <div className="grid gap-4">
              <div className="rounded-[1.8rem] border border-white/12 bg-white/10 p-6 backdrop-blur-md">
                ...
                <p className="mt-3 text-sm leading-7 text-white/78">
                  A calm place to return to your farm dashboard, orders, and marketplace work.
                </p>
              </div>
              <div className="grid gap-4 xl:grid-cols-2">
                <div className="rounded-[1.5rem] border border-white/10 bg-black/18 p-5 backdrop-blur-md">
                  ...
                  <p className="mt-2 text-sm leading-7 text-white/74">
                    Track produce, orders, and earnings in one flow.
                  </p>
                </div>
                <div className="rounded-[1.5rem] border border-white/10 bg-black/18 p-5 backdrop-blur-md">
                  <p className="text-sm font-semibold text-[#e6d4a3]">For buyers</p>
                  <p className="mt-2 text-sm leading-7 text-white/74">
                    Return to orders, marketplace activity, and account updates.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-3 max-w-sm text-sm leading-7 text-stone-600">
                  Access your account and continue buying or selling with ease.
                </p>
              </div>
              <div className="hidden rounded-2xl bg-[#ede3c7] px-4 py-3 text-right sm:block">
                <p className="text-xs uppercase tracking-[0.18em] text-stone-500">Access</p>
                <p className="mt-1 text-sm font-semibold text-stone-800">Secure sign in</p>
              </div>
            </div>
